...
public class Notifier {
	...
	static class NotificationWorker implements Runnable {
		...
		public void run() {
			...
			System.out.println(DataMapperSelector.getDataMapperList().get("application/json"));			
			System.out.println(DataMapperSelector.getDataMapperList());
			System.out.println(sub.getNotificationPayloadContentType());
			System.out.println(sub);
			System.out.println("Adeus mundo!");*/
			
			
			
			//request.setContent("tudo bem?");
			
			sub.setNotificationPayloadContentType("application/json");			
